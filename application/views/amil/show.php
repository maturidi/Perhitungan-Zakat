...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Data Amil</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="<?php echo base_url(); ?>amil/edit/<?php if($row){ echo $row->id_amil; }else{ echo $id; }?>" method="POST">
								<div class="form-group">
									<label>Nama Amil</label>
									<input type="text" value="<?php if($row){ echo $row->nama_amil; }else{ echo set_value('nama'); }?>" class="form-control" name="nama" placeholder="Nama"></input>
									<?php echo form_error('nama', '<p style="color: #a94442">', '</p>'); ?>
								</div>
								<div class="form-group">
									<label>Alamat Amil</label>
									<input type="text" value="<?php if($row){ echo $row->alamat_amil; }else{ echo set_value('alamat'); }?>" class="form-control" name="alamat" placeholder="Alamat"></input>
									<?php echo form_error('alamat', '<p style="color: #a94442">', '</p>'); ?>
								</div>
								<div class="form-group">
									<label>Email Amil</label>
									<input type="text" value="<?php if($row){ echo $row->email_amil; }else{ echo set_value('email'); }?>" class="form-control" name="email" placeholder="Email"></input>
									<?php echo form_error('email', '<p style="color: #a94442">', '</p>'); ?>
								</div>
								<div class="form-group">
									<label>No. Telepon Amil</label>
									<input type="text" value="<?php if($row){ echo $row->tlp_amil; }else{ echo set_value('tlp'); }?>" class="form-control" name="tlp" placeholder="No. Telepon"></input>
									<?php echo form_error('tlp', '<p style="color: #a94442">', '</p>'); ?>
								</div>
								<div class="form-group">
									<label>Username Amil</label>
									<input type="text" value="<?php if($row){ echo $row->username; }else{ echo set_value('username'); }?>" class="form-control" name="username" placeholder="Username"></input>
									<?php echo form_error('username', '<p style="color: #a94442">', '</p>'); ?>
								</div>
								<div class="form-group">
									<label>Password Amil</label>
									<input type="password" value="<?php if($row){ echo $row->password; }else{ echo ''; }?>" class="form-control" name="password" placeholder="Password"></input>
									<?php echo form_error('password', '<p style="color: #a94442">', '</p>'); ?>
								</div>
								<div class="form-group">
									<label>Retype Password Amil</label>
									<input type="password" value="<?php if($row){ echo $row->password; }else{ echo ''; }?>" class="form-control" name="retype-password" placeholder="Retype Password"></input>
									<?php echo form_error('retype-password', '<p style="color: #a94442">', '</p>'); ?>
								</div>
