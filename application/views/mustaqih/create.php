...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Create Data Mustahiq</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="<?php echo base_url(); ?>mustahiq/store" method="POST">
								...
								<div class="form-group">
									<label>Umur</label>
									<input type="text" value="<?php echo set_value('umur'); ?>" class="form-control" name="umur" placeholder="Umur"></input>
								...
								<div class="form-group">
									...
									<select name="macam" class="form-control">
										<?php
										foreach($macam->result() as $row) {
											if ($row->id_macam == set_value('macam')) {
												echo '<option value="'. $row->id_macam .'" selected>'. ucwords($row->nama_macam) .'</option>';
											} else {
												echo '<option value="'. $row->id_macam .'">'. ucwords($row->nama_macam) .'</option>';
											}
										}
										?>
									</select>
