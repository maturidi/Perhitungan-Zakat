...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">	
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Pilih Muzaki</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<div class="row">
                <div class="col-lg-12">
					<form action="<?php echo base_url(); ?>barang/choose" method="GET">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
												<a href="<?php echo base_url();?>barang/choosed/<?php echo $row->id_muzaki; if($id){ echo '/'.$id; } ?>" class="btn btn-primary"><span class="glyphicon glyphicon-record"></span> Pilih</a>
											</td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
