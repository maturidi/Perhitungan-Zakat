...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Create Data Barang</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                            ...
                            <form action="<?php echo base_url(); ?>barang/store" method="POST">
								<div class="col-lg-12">
									...
									<label>Pilih Muzaki Terlebih Dahulu</label>
										<div class="form-group">
											<input type="text" value="<?php if($this->session->userdata('id_muzaki')){ echo $this->session->userdata('id_muzaki'); }else{ echo set_value('id_muzaki'); } ?>" class="form-control" name="id_muzaki" placeholder="ID Muzaki" readonly></input>
											<?php echo form_error('id_muzaki', '<p style="color: #a94442">', '</p>'); ?>
										</div>
									</div>
									<div class="col-lg-4" style="padding-top:  25px;">
										<a href="<?php echo base_url(); ?>barang/choose" class="btn btn-primary"><span class="glyphicon glyphicon-record"></span> Pilih Muzaki</a>
									</div>
								</div>
								<div class="col-lg-12">
								<div class="col-lg-12">
									<div class="form-group">
										...
										<select name="id_jenis" class="form-control">
											<?php
											foreach($jenis_zakat->result() as $row) {
												if ($row->id_jenis == set_value('id_jenis')) {
													echo '<option value="'. $row->id_jenis .'" selected>'. ucwords($row->nama_jenis) .'</option>';
												} else {
													echo '<option value="'. $row->id_jenis .'">'. ucwords($row->nama_jenis) .'</option>';
												}
											}
											?>
										</select>
								...
								<div class="col-lg-12">
									<div class="col-lg-6">
										<div class="form-group">
											...
											<input type="text" value="<?php echo set_value('masuk'); ?>" class="form-control" name="masuk" placeholder="Jumlah Barang"></input>
								...
								<div class="col-lg-12">
									<div class="form-group">
										...
										<input type="text" value="<?php echo set_value('tgl_masuk'); ?>" class="form-control datepicker" id="dtp_masuk" name="tgl_masuk" placeholder="Tanggal Masuk"></input>
