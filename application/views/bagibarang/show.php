...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Data Bagi Zakat</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="<?php echo base_url(); ?>bagi_barang/edit/<?php if($row){ echo $row->id_bagi; }else{ echo $id; } ?>" method="POST">
								<div class="col-lg-12">
									<div class="col-lg-8">
									<label>Pilih Mustahiq Terlebih Dahulu</label>
										<div class="form-group">
											<input type="text" value="<?php if($this->session->userdata('id_mustahiq')){ echo $this->session->userdata('id_mustahiq'); }elseif($row){ echo $row->id_mustahiq; }else{ echo set_value('id_mustahiq'); }?>" class="form-control" name="id_mustahiq" placeholder="ID Mustahiq" readonly></input>
											<?php echo form_error('id_mustahiq', '<p style="color: #a94442">', '</p>'); ?>
										</div>
									</div>
									<div class="col-lg-4" style="padding-top:  25px;">
										<a href="<?php echo base_url(); ?>bagi_barang/choose/<?php if($row){ echo $row->id_bagi; }else{ echo $id; } ?>" class="btn btn-primary"><span class="glyphicon glyphicon-record"></span> Pilih Mustahiq</a>
									</div>
								</div>
								<div class="col-lg-12">
									<div class="col-lg-6">
										<div class="form-group">
											...
											<input type="text" value="<?php if($row){ echo $row->bagi; }else{ echo set_value('bagi'); }?>" class="form-control" name="bagi" placeholder="Barang Keluar"></input>
								...
								<div class="col-lg-12">
									<div class="form-group">
										...
										<input type="text" value="<?php if($row){ echo $row->tanggal_bagi; }else{ echo set_value('tanggal_bagi'); } ?>" class="form-control datepicker" id="tanggal_bagi" name="tanggal_bagi" placeholder="Tanggal Keluar"></input>
