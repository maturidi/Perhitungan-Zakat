...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">	
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Bagi Zakat</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<div class="row">
                <div class="col-lg-12">
					<form action="<?php echo base_url(); ?>bagi_barang" method="GET">
						<div class="col-lg-4 col-md-4 col-sm-4"style="padding-top: 7px;">
							<input type="text" name="awal" id = "dtp_awal" class="form-control datepicker" placeholder="Tanggal Awal"></input> 
						</div>
						<div class="col-lg-1 col-md-1 col-sm-1"style="padding-top: 12px;">
							<center>Sampai</center>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4"style="padding-top: 7px;">
							<input type="text" name="akhir" id="dtp_akhir" class="form-control datepicker" placeholder="Tanggal Akhir"></input>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-3">
							<div class="btn btn-group" >
								<button class="btn btn-success" type="submit"><span class="glyphicon glyphicon-search"></span> Search</button>
								<a href="<?php echo base_url(); ?>bagi_barang/create" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Add</a>
							</div>
						</div>
					</form>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ucwords($row->nama_jns_barang).' : '. $row->bagi .' '.$row->satuan_jns_barang; ?></td>
                                            <td><?php echo $row->tanggal_bagi; ?></td>
                                            <td>
												<a href="<?php echo base_url();?>bagi_barang/show/<?php echo $row->id_bagi; ?>" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
												<a href="<?php echo base_url();?>bagi_barang/destroy/<?php echo $row->id_bagi; ?>" class="btn btn-danger" onClick='return confirm("Anda yakin ingin menghapus data ini?")'><span class="glyphicon glyphicon-trash"></span> Delete</a>
											</td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
							...
							<table>
								<?php $i=0; foreach($barang->result() as $r): ?>
								<tr>
									<td>
										Sisa <?php echo ucwords($r->nama); ?>
									</td>
									<td width="15">
										<center>:</center>
									</td>
									<td>
										<?php 
											$n = $i++;
											echo $total[$n] - $bagi[$n] .' '.ucwords($r->satuan); 
										?>
									</td>
								</tr>
								<?php endforeach; ?>
	...
	<script>
		$('#dtp_awal').datepicker({format:'yyyy-mm-dd'});
		$('#dtp_akhir').datepicker({format:'yyyy-mm-dd'});
	</script>
