...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">	
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tabel Muzaki</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<div class="row">
                <div class="col-lg-12">
					<form action="<?php echo base_url(); ?>muzaki" method="POST">
						...
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="btn btn-group">
								...
								<a href="<?php echo base_url(); ?>muzaki/create" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Add</a>
							</div>
						</div>
					</form>
                </div>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row->alamat_muzaki; ?></td>
                                            <td><?php echo $row->tlp_muzaki; ?></td>
                                            <td><?php echo $row->jk_muzaki; ?></td>
                                            <td>
												<a href="<?php echo base_url();?>muzaki/show/<?php echo $row->id_muzaki; ?>" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
												<a href="<?php echo base_url();?>muzaki/destroy/<?php echo $row->id_muzaki; ?>" class="btn btn-danger" onClick='return confirm("Anda yakin ingin menghapus data ini?")'><span class="glyphicon glyphicon-trash"></span> Delete</a>
											</td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
